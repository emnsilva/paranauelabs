...
for img in prom/prometheus nginx:latest postgres:15 alexeiled/stress-ng:latest prom/node-exporter zabbix/zabbix-server-pgsql:latest; do
    docker pull $img
done
